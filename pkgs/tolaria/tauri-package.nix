...
# a runnable binary, which is the realistic goal for Nix users.
...
let
  ...
  cargoArtifacts = craneLib.buildDepsOnly {
    pname = "tolaria-deps";
    inherit version;
    src = craneLib.cleanCargoSource "${src}/src-tauri";
    cargoToml = "${src}/src-tauri/Cargo.toml";
    cargoLock = "${src}/src-tauri/Cargo.lock";
    strictDeps = true;
...
craneLib.buildPackage {
  ...
  preConfigure = ''
    # fetchPnpmDeps emits a content-addressed pnpm store, not a flat
